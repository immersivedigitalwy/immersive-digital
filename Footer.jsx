...
<h4>Services</h4>
<ul>
<li><a onClick={() => onNavigate("service:drone")} href="https://calendly.com/immersivedigital-wyg">Drone aerial</a></li>
<li><a onClick={() => onNavigate("service:real-estate")} href="https://immersivephotography.hd.pics/order">Real estate photo</a></li>
<li><a onClick={() => onNavigate("service:360")} href="https://calendly.com/immersivedigital-wyg">360 / Immersive</a></li>
<li><a onClick={() => onNavigate("service:brand")} href="https://calendly.com/immersivedigital-wyg">Brand · audit + refresh</a></li>
<li><a onClick={() => onNavigate("service:web-build")} href="https://calendly.com/immersivedigital-wyg">Web build</a></li>
<li><a onClick={() => onNavigate("service:social-plan")} href="https://calendly.com/immersivedigital-wyg">Social plan</a></li>
</ul>
</div>
...
<li><a onClick={() => onNavigate("contact")} href="https://calendly.com/immersivedigital-wyg">Book a call</a></li>
...
<a onClick={() => onNavigate("cookies")} href="/cookies" style={{ cursor: "pointer" }}>COOKIES</a>
<a>SITEMAP</a>
</div>
</div>
</div>
